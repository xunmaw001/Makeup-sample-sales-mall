...
public class YonghuController {
    ...
    public R register(@RequestBody YonghuEntity yonghu){
		...
		if(yonghu.getYonghuzhanghao() == null || yonghu.getYonghuzhanghao().equals("") ||yonghu.getYonghuzhanghao() == "null" ){
			return R.error("账户不能为空");
		}else if(yonghu.getYonghuxingming() == null || yonghu.getYonghuxingming().equals("") ||yonghu.getYonghuxingming() == "null" ){
			return R.error("密码不能为空");
		}else if(yonghu.getMima() == null || yonghu.getMima().equals("") ||yonghu.getMima() == "null" ){
			return R.error("密码不能为空");
		}
